    ...
    <div className='mt-20'>
          ...
          <div className='md:flex justify-center mt-10'>
            ...
            '>
                ...
                '
                  >
                      <h1 className='mt-5 text-gray-800 text-center text-xl md:text-2xl font-bold font-serif'>Mr. Willium Jhon</h1>
              ...
              <div className='flex flex-col justify-center mx-7 md:mt-0 mt-10'>
                <div
                className='
                relative
                md:ml-0
            ...
            '>
                ...
                '
                  >
                      <h1 className='mt-5 text-gray-800 text-center text-xl mdtext-2xl font-bold font-serif'>Mile Woatson</h1>
                      <p className='mt-3 text-gray-600 text-center'>Chef of Head</p>
                      <div className='flex gap-7 justify-center mt-3'>
                          <FaFacebookF className='text-gray-500 cursor-pointer' />
                          <AiFillInstagram className='text-gray-500 cursor-pointer' />
            ...
            '>
                ...
                '
                  >
                      <h1 className='mt-5 text-gray-800 text-center text-2xl font-bold font-serif'>Mr. Robert Jhon</h1>
                      <p className='mt-3 text-gray-600 text-center'>Chef of Head</p>
                      <div className='flex gap-7 justify-center mt-3'>
                          <FaFacebookF className='text-gray-500 cursor-pointer' />
                          <AiFillInstagram className='text-gray-500 cursor-pointer' />
